  ...
  methods: {
    ...
    decoratorOption: function decoratorOption(vnode) {
      if (vnode.data && vnode.data.directives) {
        ...
        (0, _warning2['default'])(!directive || directive && Array.isArray(directive.value), 'Invalid directive: type check failed for directive "decorator". Expected Array, got ' + (0, _typeof3['default'])(directive.value) + '. At ' + vnode.tag + '.');
    ...
    decoratorChildren: function decoratorChildren(vnodes) {
      ...
      vnodes.forEach(function (vnode, index) {
        if (vnode.children) {
          vnode.children = _this2.decoratorChildren((0, _vnode.cloneVNodes)(vnode.children));
        } else if (vnode.componentOptions && vnode.componentOptions.children) {
          vnode.componentOptions.children = _this2.decoratorChildren((0, _vnode.cloneVNodes)(vnode.componentOptions.children));
        }
        var option = _this2.decoratorOption(vnode);
        if (option && option[0]) {
