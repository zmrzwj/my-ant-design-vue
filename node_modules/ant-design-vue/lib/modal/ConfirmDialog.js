...
exports['default'] = {
  ...
  render: function render(h, context) {
    ...
    var classString = (0, _classnames2['default'])(contentPrefixCls, contentPrefixCls + '-' + props.type, prefixCls + '-' + props.type);
      ...
      [h(
        ...
        [h(
          ...
          [cancelButton, h(
            _ActionButton2['default'],
            {
              attrs: { type: okType, actionFn: onOk, closeModal: close, autoFocus: autoFocusButton === 'ok', buttonProps: okButtonProps }
            },
            [okText]
          )]
        )]
