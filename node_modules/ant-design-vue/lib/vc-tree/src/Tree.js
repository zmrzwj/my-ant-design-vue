...
var Tree = {
  ...
  props: (0, _propsUtil.initDefaultProps)({
    ...
    checkedKeys: _vueTypes2['default'].oneOfType([_vueTypes2['default'].arrayOf(_vueTypes2['default'].oneOfType([_vueTypes2['default'].string, _vueTypes2['default'].number])), _vueTypes2['default'].object]),
    ...
    loadedKeys: _vueTypes2['default'].arrayOf(_vueTypes2['default'].string),
