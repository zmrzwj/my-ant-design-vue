...
function TreeProps() {
  return {
    ...
    /** 默认展开指定的树节点 */
    defaultExpandedKeys: _vueTypes2['default'].arrayOf(String),
    /** （受控）展开指定的树节点 */
    expandedKeys: _vueTypes2['default'].arrayOf(String),
    /** （受控）选中复选框的树节点 */
    ...
    /** 默认选中复选框的树节点 */
    defaultCheckedKeys: _vueTypes2['default'].arrayOf(String),
    /** （受控）设置选中的树节点 */
    selectedKeys: _vueTypes2['default'].arrayOf(String),
    /** 默认选中的树节点 */
    defaultSelectedKeys: _vueTypes2['default'].arrayOf(String),
    ...
    loadedKeys: _vueTypes2['default'].arrayOf(String),
