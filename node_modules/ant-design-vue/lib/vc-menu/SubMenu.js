...
var SubMenu = {
  ...
  props: {
    ...
    builtinPlacements: _vueTypes2['default'].object.def({}),
  ...
  methods: {
    ...
    renderChildren: function renderChildren(children) {
      ...
      if (baseProps.openTransitionName) {
        transitionProps = (0, _getTransitionProps2['default'])(baseProps.openTransitionName, { appear: transitionAppear });
  ...
  render: function render(h) {
    ...
    var liProps = {
      on: (0, _extends4['default'])({}, (0, _omit2['default'])($listeners, ['click']), mouseEvents),
      'class': className
    };
