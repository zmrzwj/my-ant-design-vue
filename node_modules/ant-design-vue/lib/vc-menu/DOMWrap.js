    ...
    this.$nextTick(function () {
      ...
      if (_this.level === 1 && _this.mode === 'horizontal') {
        ...
        if (typeof MutationObserver !== 'undefined') {
          ...
          _this.mutationObserver.observe(menuUl, { attributes: false, childList: true, subTree: false });
        }
      }
    });
  },
  ...
  methods: {
    ...
    getOverflowedSubMenuItem: function getOverflowedSubMenuItem(keyPrefix, overflowedItems, renderPlaceholder) {
      ...
      var _getPropsData = (0, _propsUtil.getPropsData)(copy),
          ...
          rest = (0, _objectWithoutProperties3['default'])(_getPropsData, ['title', 'eventKey']); // eslint-disable-line no-unused-vars
      ...
      var subMenuProps = {
        ...
        key: key,
        style: style,
        on: (0, _propsUtil.getEvents)(copy)
      };
          ...
          if (lastVisibleIndex !== undefined && className[_this3.prefixCls + '-root'] !== -1) {
            if (index > lastVisibleIndex) {
              ...
              // 这里修改 eventKey 是为了防止隐藏状态下还会触发 openkeys 事件
              {
                ...
                'class': (0, _extends4['default'])({}, (0, _propsUtil.getClass)(childNode), (0, _defineProperty3['default'])({}, MENUITEM_OVERFLOWED_CLASSNAME, true))
              });
            }
            if (index === lastVisibleIndex + 1) {
              _this3.overflowedItems = children.slice(lastVisibleIndex + 1).map(function (c) {
                ...
                { key: (0, _propsUtil.getPropsData)(c).eventKey, props: { mode: 'vertical-left' } });
              });
