...
var Drawer = {
  ...
  methods: {
    ...
    getRcDrawerStyle: function getRcDrawerStyle() {
      ...
      return this.$data._push ? _extends({}, maskStyle, {
        zIndex: zIndex,
  ...
  render: function render() {
    ...
    var vcDrawerProps = {
      props: _extends({
        ...
        showMask: props.mask,
        placement: placement,
        wrapClassName: classNames((_classNames = {}, _defineProperty(_classNames, wrapClassName, !!wrapClassName), _defineProperty(_classNames, haveMask, !!haveMask), _classNames))
      }),
      on: _extends({
